	...
	<div class="search_jobs">
		...
		<?php if( apply_filters( 'job_manager_job_filters_show_remote_position', get_option('job_manager_enable_remote_position', true ), $atts ) ) : ?>
			<div class="search_remote_position">
				...
				<label for="remote_position" id="remote_position_label"><?php esc_html_e( 'Standing Offers only', 'wp-job-manager' ); ?></label>
			</div>
		<?php endif; ?>
		...
		?>
			<div class="search_submit">
				<input type="submit" value="<?php esc_attr_e( 'Search Rides', 'wp-job-manager' ); ?>">
			</div>
		<?php endif; ?>
